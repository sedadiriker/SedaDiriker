...
|-----------------------------|--------------------------------------|---------------------------|
| [TecnoStore](https://main--tecnostore-sd.netlify.app/) | React - useState - useEffect - usNavigation - async - await - axios - CRUD - MockApi react-router - Lifting-state-up| [Repo Link](https://github.com/sedadiriker/TecnoStore)
